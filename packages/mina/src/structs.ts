...
export class Point extends Struct({ x: Field, y: Field, z: Field }) {
  ...
  applyMatrix(matrix: Matrix) {
    ...
    this.x = matrix.n11
      .mul(x)
      .add(matrix.n12.mul(y))
      .add(matrix.n13.mul(z))
      .add(matrix.n14);
    this.y = matrix.n21
      .mul(x)
      .add(matrix.n22.mul(y))
      .add(matrix.n23.mul(z))
      .add(matrix.n24);
    this.z = matrix.n31
      .mul(x)
      .add(matrix.n32.mul(y))
      .add(matrix.n33.mul(z))
      .add(matrix.n34);
  }
}
...
export class Matrix extends Struct({
  ...
  multiply(matrix: Matrix) {
    return new Matrix({
      n11: this.n11
        .mul(matrix.n11)
        .add(this.n12.mul(matrix.n21))
        .add(this.n13.mul(matrix.n31))
        .add(this.n14.mul(matrix.n41)),
      n12: this.n11
        .mul(matrix.n12)
        .add(this.n12.mul(matrix.n22))
        .add(this.n13.mul(matrix.n32))
        .add(this.n14.mul(matrix.n42)),
      n13: this.n11
        .mul(matrix.n13)
        .add(this.n12.mul(matrix.n23))
        .add(this.n13.mul(matrix.n33))
        .add(this.n14.mul(matrix.n43)),
      n14: this.n11
        .mul(matrix.n14)
        .add(this.n12.mul(matrix.n24))
        .add(this.n13.mul(matrix.n34))
        .add(this.n14.mul(matrix.n44)),
      n21: this.n21
        .mul(matrix.n11)
        .add(this.n22.mul(matrix.n21))
        .add(this.n23.mul(matrix.n31))
        .add(this.n24.mul(matrix.n41)),
      n22: this.n21
        .mul(matrix.n12)
        .add(this.n22.mul(matrix.n22))
        .add(this.n23.mul(matrix.n32))
        .add(this.n24.mul(matrix.n42)),
      n23: this.n21
        .mul(matrix.n13)
        .add(this.n22.mul(matrix.n23))
        .add(this.n23.mul(matrix.n33))
        .add(this.n24.mul(matrix.n43)),
      n24: this.n21
        .mul(matrix.n14)
        .add(this.n22.mul(matrix.n24))
        .add(this.n23.mul(matrix.n34))
        .add(this.n24.mul(matrix.n44)),
      n31: this.n31
        .mul(matrix.n11)
        .add(this.n32.mul(matrix.n21))
        .add(this.n33.mul(matrix.n31))
        .add(this.n34.mul(matrix.n41)),
      n32: this.n31
        .mul(matrix.n12)
        .add(this.n32.mul(matrix.n22))
        .add(this.n33.mul(matrix.n32))
        .add(this.n34.mul(matrix.n42)),
      n33: this.n31
        .mul(matrix.n13)
        .add(this.n32.mul(matrix.n23))
        .add(this.n33.mul(matrix.n33))
        .add(this.n34.mul(matrix.n43)),
      n34: this.n31
        .mul(matrix.n14)
        .add(this.n32.mul(matrix.n24))
        .add(this.n33.mul(matrix.n34))
        .add(this.n34.mul(matrix.n44)),
      n41: this.n41
        .mul(matrix.n11)
        .add(this.n42.mul(matrix.n21))
        .add(this.n43.mul(matrix.n31))
        .add(this.n44.mul(matrix.n41)),
      n42: this.n41
        .mul(matrix.n12)
        .add(this.n42.mul(matrix.n22))
        .add(this.n43.mul(matrix.n32))
        .add(this.n44.mul(matrix.n42)),
      n43: this.n41
        .mul(matrix.n13)
        .add(this.n42.mul(matrix.n23))
        .add(this.n43.mul(matrix.n33))
        .add(this.n44.mul(matrix.n43)),
      n44: this.n41
        .mul(matrix.n14)
        .add(this.n42.mul(matrix.n24))
        .add(this.n43.mul(matrix.n34))
        .add(this.n44.mul(matrix.n44)),
    });
  }
  ...
  premultiply(matrix: Matrix) {
    return new Matrix({
      n11: matrix.n11
        .mul(this.n11)
        .add(matrix.n12.mul(this.n21))
        .add(matrix.n13.mul(this.n31))
        .add(matrix.n14.mul(this.n41)),
      n12: matrix.n11
        .mul(this.n12)
        .add(matrix.n12.mul(this.n22))
        .add(matrix.n13.mul(this.n32))
        .add(matrix.n14.mul(this.n42)),
      n13: matrix.n11
        .mul(this.n13)
        .add(matrix.n12.mul(this.n23))
        .add(matrix.n13.mul(this.n33))
        .add(matrix.n14.mul(this.n43)),
      n14: matrix.n11
        .mul(this.n14)
        .add(matrix.n12.mul(this.n24))
        .add(matrix.n13.mul(this.n34))
        .add(matrix.n14.mul(this.n44)),
      n21: matrix.n21
        .mul(this.n11)
        .add(matrix.n22.mul(this.n21))
        .add(matrix.n23.mul(this.n31))
        .add(matrix.n24.mul(this.n41)),
      n22: matrix.n21
        .mul(this.n12)
        .add(matrix.n22.mul(this.n22))
        .add(matrix.n23.mul(this.n32))
        .add(matrix.n24.mul(this.n42)),
      n23: matrix.n21
        .mul(this.n13)
        .add(matrix.n22.mul(this.n23))
        .add(matrix.n23.mul(this.n33))
        .add(matrix.n24.mul(this.n43)),
      n24: matrix.n21
        .mul(this.n14)
        .add(matrix.n22.mul(this.n24))
        .add(matrix.n23.mul(this.n34))
        .add(matrix.n24.mul(this.n44)),
      n31: matrix.n31
        .mul(this.n11)
        .add(matrix.n32.mul(this.n21))
        .add(matrix.n33.mul(this.n31))
        .add(matrix.n34.mul(this.n41)),
      n32: matrix.n31
        .mul(this.n12)
        .add(matrix.n32.mul(this.n22))
        .add(matrix.n33.mul(this.n32))
        .add(matrix.n34.mul(this.n42)),
      n33: matrix.n31
        .mul(this.n13)
        .add(matrix.n32.mul(this.n23))
        .add(matrix.n33.mul(this.n33))
        .add(matrix.n34.mul(this.n43)),
      n34: matrix.n31
        .mul(this.n14)
        .add(matrix.n32.mul(this.n24))
        .add(matrix.n33.mul(this.n34))
        .add(matrix.n34.mul(this.n44)),
      n41: matrix.n41
        .mul(this.n11)
        .add(matrix.n42.mul(this.n21))
        .add(matrix.n43.mul(this.n31))
        .add(matrix.n44.mul(this.n41)),
      n42: matrix.n41
        .mul(this.n12)
        .add(matrix.n42.mul(this.n22))
        .add(matrix.n43.mul(this.n32))
        .add(matrix.n44.mul(this.n42)),
      n43: matrix.n41
        .mul(this.n13)
        .add(matrix.n42.mul(this.n23))
        .add(matrix.n43.mul(this.n33))
        .add(matrix.n44.mul(this.n43)),
      n44: matrix.n41
        .mul(this.n14)
        .add(matrix.n42.mul(this.n24))
        .add(matrix.n43.mul(this.n34))
        .add(matrix.n44.mul(this.n44)),
    });
  }
