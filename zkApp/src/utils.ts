...
export const computeTranslationToOriginMatrix = (vertices: Float32Array): THREE.Matrix4 => {
  ...
  return new THREE.Matrix4().makeTranslation(translationToOrigin.x, translationToOrigin.y, translationToOrigin.z);
}

export const computeTranslationToPositiveCoordsMatrix = (rwHiddenObject: {coords: number[], radius: number}): THREE.Matrix4 => {
  ...
  return new THREE.Matrix4().makeTranslation(translationToPositiveCoords.x, translationToPositiveCoords.y, translationToPositiveCoords.z);                                                    
}