...
function useTrackControllers(): useTrackControllersReturn {
  ...
  const leftControllerPosition = useRef(new Vector3());
  const rightControllerPosition = useRef(new Vector3());
  const leftControllerOrientation = useRef(new Quaternion());
  const rightControllerOrientation = useRef(new Quaternion());
